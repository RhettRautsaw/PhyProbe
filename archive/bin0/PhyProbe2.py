...
if '2' in steps:
	...
	sp.call("cp 01_assembly/transcripts.fasta tmp_busco.fasta", shell=True)
	sp.call("Fasta_Renamer.py -f tmp_busco.fasta -n spadesContig", shell=True)
	sp.call("busco -i tmp_busco.fasta -c " + str(cpus) + " -o 02_busco -m geno -l " + lineage, shell=True)
...
#iqtree -s {}.cleaned.fasta -bb 1000 -seed 12345'
#
#for i in `cat loci.list`
#	do echo $i
#	cat $i/$i.cleaned.contree >> gene_trees.newick
#	done
#
